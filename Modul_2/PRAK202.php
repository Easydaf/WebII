...
if (isset($_POST["submit"])) {
    ...
    empty($_POST['nim']) ? $nimErr = "nim tidak boleh kosong" : $nim = $_POST["nim"];
    empty($_POST['jenisKelamin']) ? $jenisKelaminErr = "jenis kelamin tidak boleh kosong" : $jenisKelamin = $_POST["jenisKelamin"];
}
?>
<!DOCTYPE html>
